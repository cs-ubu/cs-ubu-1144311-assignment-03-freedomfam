...
def Decimal32(req):
	if req.method == 'POST':
		...
		e = b[1:9]
		f = b[9:33]
		return render(req,'Decimal32.html',{'s':s,'e':e,'f':f,'b':b,'d':d})
	else :
		return render(req,'Decimal32.html')
...
def Decimal64(req):
	if req.method == 'POST':
		...
		return render(req,'Decimal64.html',{'s':s,'e':e,'f':f,'d':d,'b':b})
	else:
		return render(req,'Decimal64.html')
	#pass
